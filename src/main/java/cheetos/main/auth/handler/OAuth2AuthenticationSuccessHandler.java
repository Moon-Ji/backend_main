package cheetos.main.auth.handler;
...
import cheetos.main.auth.userInfo.OAuth2UserInfoFactory;
import cheetos.main.common.utils.CookieUtil;
import cheetos.main.user.domain.Provider;
import cheetos.main.user.domain.Role;
import cheetos.main.user.domain.UserRefreshToken;
...
import static cheetos.main.auth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static cheetos.main.auth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        setRefreshToken(request, response, now, userInfo);
    ...
    protected void setRefreshToken(HttpServletRequest request, HttpServletResponse response, Date now, OAuth2UserInfo userInfo) {
        // refresh 토큰 설정
